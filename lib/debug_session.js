...
var DebugSession = (function (_super) {
    ...
    DebugSession.prototype.breakExpression = function (expression) {
        return this.getCommandOutput("break-watch " + expression, null, extractors_1.extractBreakpointInfo);
    };
    //
            ...
            if (Array.isArray(output.threads)) {
                ...
                var threads = output.threads.map(function (data) {
                    ...
                    if (thread.id === currentThreadId) {
                        currentThread_1 = thread;
                    }
                    return thread;
                });
                return { all: threads, current: currentThread_1 };
            }
