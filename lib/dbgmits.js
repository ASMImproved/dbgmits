...
;
function startGDBDebugSessionFromExistingProcess(stdout, stdin, exitSubject) {
    var debugSession = null;
    debugSession = new debug_session_1.default(stdout, stdin);
    exitSubject.then(function () {
        debugSession.end(false);
    });
    return debugSession;
}
exports.startGDBDebugSessionFromExistingProcess = startGDBDebugSessionFromExistingProcess;
